...
#
#
# f = zipfile.ZipFile('充提差为正的.zip', 'w', zipfile.ZIP_DEFLATED)
#
# f.write('/Volumes/Macintosh/books/dushu-master/dushu/text.txt')
#
# f.close()
